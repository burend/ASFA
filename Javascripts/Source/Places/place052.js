...
function ShowPlace52()
{
	...
	if (wherePerson("Kurndorf") == 6) {
		// Ghost is here
		md.write('<p>You see the ghostly man again.  He is standing in front of a picture of a bull painted on the wall.  Its almost as if he is waiting for you...</p>');
	}

	md.write('<p>There are some gutters in the ground with grates stopping you stepping in and hurting yourself but they aer rough and can trip you if you are not careful.');
