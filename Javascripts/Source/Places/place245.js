...
function ShowPlace245()
{
	...
	if (whereItem(42) == 245) md.write('<p>Evidently Gina left a note for the Mayor on the security desk.</p><br>');
	if (perG.isCharmedBy() && perG.place == 0 && !isPossess() && !checkPersonFlag("Lola", 3)) md.write("<p>Gina mentions that you may be interested in the Museum Curator...</p>");
